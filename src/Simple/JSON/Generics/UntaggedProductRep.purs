module Simple.JSON.Generics.UntaggedProductRep where
...
untaggedProductRep :: forall a rep
   . GR.Generic a rep
...
instance untaggedProductRepConstructor ::
  ...
  genericUntaggedProductRep i f = GR.Constructor <$> genericUntaggedProductRep i f
